...
$(function() {
    $(".inlinetask .info").hide().closest('.inlinetask').addClass('info');
    $(".inlinetask .tip").hide().closest('.inlinetask').addClass('tip');
    $(".inlinetask .note").hide().closest('.inlinetask').addClass('note');
    $(".inlinetask .warning").hide().closest('.inlinetask').addClass('warning');
    $(".inlinetask .error").hide().closest('.inlinetask').addClass('error');
});
...
function tabifySections() {
    ...
    $('.outline-2')
        .each(function() {
            ...
            var tabText = $(this).find('h2').clone().find('span').remove().end()
                .text().trim();
...
$(function() {
    ...
    $('#toTop').click(function() {
        ...
        return false;                   // Disable default browser behavior
    });
});
